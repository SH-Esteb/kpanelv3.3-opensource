  ...
  function fn_subscribeForm() {
    ...
    $form.validate({
      ...
      submitHandler: function(form) {
        $(form).ajaxSubmit({
          type: 'POST',
          url: 'assetsindex/php/subscribe.php',
          dataType: 'json',
          cache: false,
          data: $form.serialize(),
...
=================================================*/
  ...
  function fn_slider() {
    ...
    for (var i = 1; i <= _imgAmount; i++) {
      $('#img').append('<img src="assetsindex/img/bg/slideshow-' + (i < 10 ? '0' + i : i) + '.jpg?v=1234">');
    }
...
=================================================*/
  function fn_videoBg() {
    ...
    if (!isMobile) {
      $video.append('<video id="video-bg" autoplay loop><source src="assetsindex/video/video.mp4" type="video/mp4"></video>');
      if (_videoMute) {
        var video = document.getElementById('video-bg');
        video.muted = true;
      }
  ...
  function fn_audio() {
    ...
    if (_audio) {
      if (_bgStyle == 1 || _bgStyle == 2) {
        ...
        if (isMobile) {
          $body.addClass('volume-off');
          $audioPlayer.animate({volume: 0.0}, 3000);
          $audioPlayer.pause();
        } else {
          $body.addClass('volume-on');
          fn_volumeOn();
          $audioPlayer.animate({volume: 1.0}, 3000);
          $audioPlayer.play();
        }
