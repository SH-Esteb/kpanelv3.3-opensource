          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Chat <button class="clear-button" onclick="ClearChat()" >Clear</button></h4>
                    <div class="table-responsive">
                      <div class="panel-body" id="chat-body"></div>
                    </div>
                    <center><br>
                    <h4 style="color: white!important;">Message :</h4>
                    <input type="text" id="message" class="form-control noEnterSubmit" required />
                  </p>

                  <button type="button" class="btn btn-warning" onclick="AddMessage()"><i class="mdi mdi-telegram" aria-hidden="true"></i>&nbsp;Submit</button></center>
                  </div>
                </div>
              </div>
            </div>
