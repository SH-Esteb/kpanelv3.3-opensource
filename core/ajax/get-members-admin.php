...
$all_admins_predata = Account::GetAllAdmin();

if(empty($all_admins_predata)) {
	die("<br><div class=\"text-center\">Aucun administrateur</div>");
}

foreach ($all_admins_predata as $data) {
