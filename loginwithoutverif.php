...
if(get('code')) {
  ...
  $token = apiRequest($tokenURL, array(
    ...
    'redirect_uri' => 'https://kpanel.cz/loginwithoutverif',
    'code' => get('code')
  ));
  ...
  $_SESSION['client_id'] = $token->client_id;
...
if(session('access_token')) {
  ...
  if (strpos($collabo, 'error') !== false) {
    if (!isset($_SESSION['bad'])) {
      $_SESSION['bad'] = 'eeee';
      header('Location: /home/error.php?discord=aaaa');
    }
