...
<html lang="en">
  <head>
    ...
    <!-- inject:css -->
    <style>
    #server_list_previous {
      margin-left: 25px;
    }
     #server_list_previous, .paginate_button {
       margin-right: 5px;
     }
    </style>
    <!-- endinject -->
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="modal fade" id="rcon-modal" tabindex="-1" role="dialog">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  ...
                  <div class="modal-body" id="rcon-body">
                      <div class="form-group">
                  ...
                  <div class="modal-footer" id="serverpayload-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Annuler</button>
                    <button type="button" onclick="rcon()" class="btn btn-primary">Charger le Payload</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="server_list" cellspacing="0" width="100%" class="table">
                          <br>
                          <thead>
    ...
    function showrcon(id)
    {
        action_server_id = id;
        $("#rcon-modal").modal("show");
    }

    function rcon()
    {
        var request = $("#rcon-text").val();

        $.ajax({
          method: "POST",
          url: "core/ajax/rcon.php",
          data: { id: action_server_id, request: request }
        });
    }
    ...
    $('#serverpayload-modal').on('hidden.bs.modal', function () {
        $("#serverpayload-body").html('<div class="form-group"><label>Payload</label><select class="form-control" id="server-payload"></select></div><div class="form-group" id="thearg" style="display: none;"><label>Argument</label><input class="form-control" id="payload-arg" placeholder="Argument"></div>');
