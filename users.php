...
<html lang="en">
  <head>
    ...
    <title>kPanel | Utilisateurs</title>
    <!-- plugins:css -->
    ...
    #users_list_previous {
     ...
     #users_list_previous, .paginate_button {
       margin-right: 5px;
     }
    </style>
    <!-- endinject -->
  ...
  <body>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Définir un role</h4>
                  </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table id="users_list" cellspacing="0" width="100%" class="table">
                        <br>
                          <thead>
                              <tr>
    ...
    {
      $.ajax({
        url: "core/ajax/banhim.php?id=" + id,
      });
    }
